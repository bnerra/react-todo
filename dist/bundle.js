...
class App extends React.Component {
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(TodoList_1.default, { todos: todos })));
    }
}
exports.App = App;
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const TableRow_1 = __webpack_require__(/*! @material-ui/core/TableRow */ "./node_modules/@material-ui/core/TableRow/index.js");
const TableCell_1 = __webpack_require__(/*! @material-ui/core/TableCell */ "./node_modules/@material-ui/core/TableCell/index.js");
...
class TodoItem extends React.Component {
    ...
    editTodo(event) {
        this.setState(Object.assign({}, this.state, { [event.currentTarget.name]: event.currentTarget.value }));
        this.props.update(Object.assign({}, this.state, { [event.currentTarget.name]: event.currentTarget.value }));
    }
    render() {
        ...
        if (this.state.inEditMode) {
            titleDisplay = React.createElement(TextField_1.default, { name: "title", value: this.state.title, onChange: this.editTodo });
            summaryDisplay = React.createElement(TextField_1.default, { name: "summary", value: this.state.summary, onChange: this.editTodo });
        }
        else {
            titleDisplay = React.createElement("h2", null, this.state.title);
            summaryDisplay = React.createElement("p", null, this.state.summary);
        }
        return (React.createElement(TableRow_1.default, null,
            ...
            React.createElement(TableCell_1.default, null, titleDisplay),
            React.createElement(TableCell_1.default, null, summaryDisplay),
            React.createElement(TableCell_1.default, null,
                React.createElement("button", { onClick: this.toggleEditMode }, this.state.inEditMode ? 'Stop Editing' : 'Edit')),
            React.createElement(TableCell_1.default, null,
                React.createElement("button", { onClick: this.props.remove }, "Delete"))));
    }
}
...
const styles = __webpack_require__(/*! ./TodoList.css */ "./src/components/TodoList.css");
const utils_1 = __webpack_require__(/*! ../utils */ "./src/utils.ts");
const TodoItem_1 = __webpack_require__(/*! ./TodoItem */ "./src/components/TodoItem.tsx");
const Paper_1 = __webpack_require__(/*! @material-ui/core/Paper */ "./node_modules/@material-ui/core/Paper/index.js");
const Grid_1 = __webpack_require__(/*! @material-ui/core/Grid */ "./node_modules/@material-ui/core/Grid/index.js");
const TextField_1 = __webpack_require__(/*! @material-ui/core/TextField */ "./node_modules/@material-ui/core/TextField/index.js");
const Button_1 = __webpack_require__(/*! @material-ui/core/Button */ "./node_modules/@material-ui/core/Button/index.js");
const Icon_1 = __webpack_require__(/*! @material-ui/core/Icon */ "./node_modules/@material-ui/core/Icon/index.js");
const Table_1 = __webpack_require__(/*! @material-ui/core/Table */ "./node_modules/@material-ui/core/Table/index.js");
const TableHead_1 = __webpack_require__(/*! @material-ui/core/TableHead */ "./node_modules/@material-ui/core/TableHead/index.js");
const TableBody_1 = __webpack_require__(/*! @material-ui/core/TableBody */ "./node_modules/@material-ui/core/TableBody/index.js");
const TableRow_1 = __webpack_require__(/*! @material-ui/core/TableRow */ "./node_modules/@material-ui/core/TableRow/index.js");
const TableCell_1 = __webpack_require__(/*! @material-ui/core/TableCell */ "./node_modules/@material-ui/core/TableCell/index.js");
...
class TodoList extends React.Component {
    ...
    render() {
        ...
        let todoDialog = React.createElement("div", null,
            React.createElement(Button_1.default, { variant: "contained", color: "secondary", onClick: this.handleClickOpen }, "Add New Todo"),
            React.createElement(Dialog_1.default, { open: this.state.dialogOpen, onClose: this.handleClose, "aria-labelledby": "add-new-todo" },
                React.createElement(DialogTitle_1.default, { id: "add-new-todo" }, "Add New Todo"),
                React.createElement(DialogContent_1.default, null,
                    React.createElement(Grid_1.default, { container: true, spacing: 16, direction: "column" },
                        React.createElement(Grid_1.default, { item: true, xs: 12 },
                            React.createElement(Paper_1.default, null,
                                React.createElement(TextField_1.default, { className: styles.TextField, label: "Title", name: "addTodoTitle", value: this.state.addTodoTitle, onChange: this.handleChange, placeholder: "Enter task" }))),
                        React.createElement(Grid_1.default, { item: true, xs: 12 },
                            React.createElement(Paper_1.default, null,
                                React.createElement(TextField_1.default, { className: styles.TextField, label: "Description", multiline: true, rows: "3", name: "addTodoSummary", value: this.state.addTodoSummary, onChange: this.handleChange, placeholder: "Enter task summary" }))))),
                React.createElement(DialogActions_1.default, null,
                    React.createElement(Button_1.default, { onClick: this.handleClose }, "Cancel"),
                    React.createElement(Button_1.default, { className: styles.addButton, variant: "contained", color: "primary", onClick: this.addTodo },
                        "Add",
                        React.createElement(Icon_1.default, null, "add")))));
        let taskItems = this.props.todos.map((item, index) => {
            return (React.createElement(TodoItem_1.TodoItem, { key: item.id, title: item.title, summary: item.summary, completed: item.done, id: item.id, update: (obj) => this.updateTodo(obj, index), remove: () => this.removeTodo(index) }));
        });
            ...
            React.createElement(Grid_1.default, { container: true, spacing: 16, direction: "column" },
                React.createElement(Grid_1.default, { item: true, xs: 12 },
                    ...
                    React.createElement(Button_1.default, { className: styles.addButton, variant: "contained", color: "primary", onClick: this.addTodo },
                        "Add",
                        React.createElement(Icon_1.default, null, "add"))),
                React.createElement(Grid_1.default, { item: true, xs: 12 }, todoDialog)),
            React.createElement("br", null),
            React.createElement(Grid_1.default, { container: true, spacing: 24 },
                React.createElement(Paper_1.default, { className: styles.TableRoot },
                    React.createElement(Table_1.default, null,
                        React.createElement(TableHead_1.default, null,
                            React.createElement(TableRow_1.default, null,
                                React.createElement(TableCell_1.default, null, "Completed"),
                                React.createElement(TableCell_1.default, null, "Title"),
                                React.createElement(TableCell_1.default, null, "Description"),
                                React.createElement(TableCell_1.default, null, "Edit"),
                                React.createElement(TableCell_1.default, null, "Delete"))),
                        React.createElement(TableBody_1.default, null, taskItems))))));
    }
}
